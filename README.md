...
- dryness.py: Conta quantos blocos de 5 linhas exatamente iguais temos globalmente dentro do arquivo. Isso pode contar estruturas padrões de certos tipos de ferramentas.
